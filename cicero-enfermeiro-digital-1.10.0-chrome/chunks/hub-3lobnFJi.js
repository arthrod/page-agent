...
var HubWs = class {
	...
	async #checkApproval() {
		...
		const { allowAllHubConnection } = await chrome.storage.local.get(
			"allowAllHubConnection",
		);
...
function useHubWs(execute, stop, configure, config) {
	...
	const [wsState, setWsState] = (0, import_react.useState)(() =>
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						...
						className:
							"flex items-center gap-2 px-5 h-12 border-b hover:bg-muted/30 transition-colors",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className:
									"text-[9px] font-medium uppercase tracking-wider text-amber-600 bg-amber-500/10 border border-amber-500/30 rounded px-1.5 py-0.5",
								children: "Beta",
							}),
						],
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className:
									"text-xs text-muted-foreground leading-relaxed space-y-2",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										children:
											"Cícero Hub lets local apps (e.g. MCP servers) control the Cícero extension via WebSocket.",
									}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className:
							"border-t px-5 py-3 text-[10px] text-muted-foreground/60 flex items-center justify-between",
						children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WsIcon, {
										className: "size-3.5",
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										children: wsLabel,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className:
							"group-hover/hub:visible group-hover/hub:opacity-100 transition-opacity duration-150  left-0 right-0 top-full z-10 pt-2",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className:
								"relative p-2.5 rounded-md border border-border bg-background/60 backdrop-blur-md shadow-2xl text-muted-foreground text-xs leading-relaxed",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className:
										"absolute -top-1.5 left-5 size-3 rotate-45 rounded-[1px] border-l border-t border-border bg-background/60 backdrop-blur-md",
								}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				className:
					"flex items-center gap-1 text-[11px] font-semibold text-foreground/80 uppercase tracking-wider cursor-pointer",
				children: [
					"Docs",
					open
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
									className:
										"text-[11px] font-medium text-foreground/60 mb-1.5",
									children: "Flow",
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
									className:
										"list-decimal list-inside space-y-1 text-[11px] leading-relaxed",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
											children: "Hub opens WS to caller's server",
										}),
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
											children: "Hub runs agent, streams events",
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
											children: [
												"Hub sends ",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", {
									className:
										"bg-muted/50 rounded-md p-3 font-mono text-[10px] leading-relaxed whitespace-pre-wrap",
