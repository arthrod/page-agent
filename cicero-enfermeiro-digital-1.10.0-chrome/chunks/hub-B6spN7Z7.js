import { D as require_react, E as require_client, O as __toESM, T as createLucideIcon, a as StatusDot, c as EventCard, h as require_jsx_runtime, i as MotionOverlay, l as useAgent, m as Button, p as ErrorBoundary, r as Logo, s as ActivityCard, t as Switch, v as UnfoldVertical, x as FoldVertical, y as Square } from "./assets-yVXovJuc.js";
/**
...
var HubWs = class {
	...
	async #checkApproval() {
		...
		const ok = window.confirm("An external application is requesting to control your browser via Cícero.\nAllow this session?");
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Cícero Hub lets local apps (e.g. MCP servers) control the Cícero extension via WebSocket." }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
