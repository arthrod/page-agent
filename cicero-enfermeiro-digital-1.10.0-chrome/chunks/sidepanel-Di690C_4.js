import {
	...
	O as __toESM,
	S as Eye,
	T as createLucideIcon,
	_ as cva,
	a as StatusDot,
	b as RotateCcw,
	c as EventCard,
	f as isTestingEndpoint,
	g as cn,
	h as require_jsx_runtime,
	i as MotionOverlay,
	l as useAgent,
	m as Button,
	n as EmptyState,
...
function ConfigPanel({ config, onSave, onClose }) {
	...
	const [pingPong, setPingPong] = (0, import_react.useState)(
		config?.pingPong ?? false,
	);
	const [alwaysSendScreenshot, setAlwaysSendScreenshot] = (0,
	import_react.useState)(config?.alwaysSendScreenshot ?? false);
	const [maxSteps, setMaxSteps] = (0, import_react.useState)(config?.maxSteps);
	const [systemInstruction, setSystemInstruction] = (0, import_react.useState)(
		config?.systemInstruction ?? "",
	);
	const [experimentalLlmsTxt, setExperimentalLlmsTxt] = (0,
	import_react.useState)(config?.experimentalLlmsTxt ?? false);
	const [experimentalIncludeAllTabs, setExperimentalIncludeAllTabs] = (0,
	import_react.useState)(config?.experimentalIncludeAllTabs ?? false);
	const [disableNamedToolChoice, setDisableNamedToolChoice] = (0,
	import_react.useState)(config?.disableNamedToolChoice ?? false);
	...
	(0, import_react.useEffect)(() => {
		...
		const fetchToken = async () => {
			const token = (
				await chrome.storage.local.get("PageAgentExtUserAuthToken")
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
				...
				className:
					"flex items-center justify-between p-3 rounded-md border bg-muted/50 text-xs font-medium text-muted-foreground hover:text-foreground hover:border-foreground/20 transition-colors",
				children: [
			...
			isTestingEndpoint(baseURL) &&
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className:
						"p-2.5 rounded-md border border-amber-500/30 bg-amber-500/5 text-[11px] text-muted-foreground leading-relaxed",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scale, {
							className: "size-3 inline-block mr-1 -mt-0.5 text-amber-600",
						}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
						...
						className:
							"h-8 text-xs rounded-md border border-input bg-background px-2 cursor-pointer",
						children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-[10px] text-muted-foreground",
								children:
									"Envia uma captura de tela em todo passo (mais lento). Em erros, a captura é sempre enviada.",
							}),
						],
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				className:
					"flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground cursor-pointer mt-1 font-bold",
				children: [
					"Advanced",
					advancedOpen
						? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FoldVertical, {
								className: "size-3",
							})
						: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UnfoldVertical, {
								className: "size-3",
							}),
				],
			}),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
										...
										className:
											"text-xs h-8 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none [-moz-appearance:textfield]",
									}),
								],
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
										...
										rows: 3,
										className:
											"text-xs rounded-md border border-input bg-background px-3 py-2 resize-y min-h-[60px]",
									}),
								],
							}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className:
					"mt-4 mb-4 pt-4 border-t border-border/50 flex gap-2 justify-between text-[10px] text-muted-foreground",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
								...
								className: "flex items-center gap-1 hover:text-foreground",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HatGlasses, {
										className: "size-3",
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										children: "Privacy",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className:
					"text-[10px] text-muted-foreground bg-background fixed bottom-0 w-full flex justify-around",
...
async function listSessions() {
	return (
		await (await getDB()).getAllFromIndex("sessions", "by-created")
	).reverse();
}
...
function HistoryDetail({ sessionId, onBack, onRerun }) {
	...
	if (!session)
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className:
				"flex items-center justify-center h-screen text-xs text-muted-foreground",
			children: "Loading...",
		});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className:
									"flex items-center gap-1 text-[10px] text-muted-foreground hover:text-foreground transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed",
								children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className:
									"flex items-center gap-1 text-[10px] text-muted-foreground hover:text-destructive transition-colors cursor-pointer",
								children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: session.history.map((event, index) =>
				...
				children: [
					...
					sessions.length > 0 &&
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							...
							className:
								"text-[10px] text-muted-foreground hover:text-destructive cursor-pointer h-6 px-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
									"div",
									{
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className:
													"size-3.5 mt-0.5 rounded-full bg-muted animate-pulse shrink-0",
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className:
															"h-2.5 bg-muted animate-pulse rounded w-3/4",
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className:
															"h-2 bg-muted animate-pulse rounded w-1/3",
													}),
												],
											}),
										],
					...
					!loading &&
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className:
								"flex flex-col items-center justify-center h-40 gap-2 text-muted-foreground",
							children: [
					...
					sessions.map((session) =>
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
							"div",
							{
								...
								className:
									"w-full text-left px-3 py-2.5 border-b hover:bg-muted/50 transition-colors cursor-pointer flex items-start gap-2 group",
								children: [
									session.status === "completed"
										? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
												CircleCheckBig,
												{
													className: "size-3.5 text-green-500 shrink-0 mt-0.5",
												},
											)
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														className:
															"flex items-center gap-0.5 ml-auto opacity-0 group-hover:opacity-100 transition-opacity",
														children: [
															/* @__PURE__ */ (0, import_jsx_runtime.jsx)(
																"button",
																{
																	...
																	className:
																		"p-0.5 text-muted-foreground hover:text-foreground transition-colors cursor-pointer",
																	title: "Run task again",
																	"aria-label": `Run history task again: ${session.task}`,
																	children: /* @__PURE__ */ (0,
																	import_jsx_runtime.jsx)(RotateCcw, {
																		className: "size-3",
																	}),
																},
															),
															/* @__PURE__ */ (0, import_jsx_runtime.jsx)(
																"button",
																{
																	...
																	children: /* @__PURE__ */ (0,
																	import_jsx_runtime.jsx)(ArrowDownToLine, {
																		className: "size-3",
																	}),
																},
															),
															/* @__PURE__ */ (0, import_jsx_runtime.jsx)(
																"button",
																{
																	...
																	className:
																		"p-0.5 text-muted-foreground hover:text-destructive transition-colors cursor-pointer",
...
async function blobToBase64(blob) {
	const dataUrl = await new Promise((resolve, reject) => {
		...
		reader.onerror = () => {
			reject(
				reader.error ?? /* @__PURE__ */ new Error("Failed to read audio blob"),
			);
		};
...
var GeminiAudioTranscriber = class {
	...
	async start() {
		...
		try {
			...
			throw new Error(
				"Não consegui acessar o microfone. Verifique a permissão e tente de novo.",
			);
		}
	...
	async stop() {
		...
		const base64 = await blobToBase64(
			encodeWav(
				downsampleBuffer(samples, sampleRate, TARGET_SAMPLE_RATE),
				TARGET_SAMPLE_RATE,
			),
		);
		if (this.#aborted) return "";
	...
	async #transcribe(base64) {
		...
		try {
			...
			if (this.#aborted) return "";
			throw new Error(
				"Não consegui falar com o serviço de transcrição. Verifique a internet.",
			);
		}
		if (!response.ok)
			throw new Error(
				"O serviço de transcrição recusou o áudio. Tente novamente.",
			);
		let json;
		try {
			...
			throw new Error(
				"Recebi uma resposta inválida do serviço de transcrição.",
			);
		}
	...
	start() {
		...
		return new Promise((resolve, reject) => {
			...
			recognition.onend = () => {
				...
				this.#failStart(
					this.#error ??
						/* @__PURE__ */ new Error("O reconhecimento de voz não iniciou."),
				);
				this.#settleStop();
			};
			...
			try {
				...
				reject(
					/* @__PURE__ */ new Error(
						"Não consegui iniciar o reconhecimento de voz.",
					),
				);
			}
		});
...
function App() {
	...
	const speak = (0, import_react.useCallback)(
		(text) => {
	...
	const focusInput = (0, import_react.useCallback)(() => {
		const doFocus = () => {
			const el = document.getElementById("cicero-task-input");
	...
	const runTask = (0, import_react.useCallback)(
		(task) => {
			...
			execute(normalizedTask)
				.then((result) => {
					if (result?.success && result.data) speak(String(result.data));
						...
						speak(
							"Não consegui concluir agora. Podemos tentar de outro jeito?",
						);
				})
				.catch((error) => {
	...
	(0, import_react.useEffect)(() => {
		...
		if (justFinished) {
			focusInput();
			if (status === "error")
				speak("Tive um probleminha, mas pode tentar de novo.");
	...
	(0, import_react.useEffect)(() => {
		...
		const badge = (text, color) => {
			...
			if (text && color) action.setBadgeBackgroundColor({ color });
		};
		let title = "Cícero";
		...
		} else if (status === "error") badge("!", "#ef4444");
	...
	(0, import_react.useEffect)(() => {
		const onKey = (e) => {
			if (
				...
				!e.shiftKey &&
				(micState === "listening" || micState === "transcribing") &&
				document.activeElement?.id !== "cicero-task-input"
			) {
				e.preventDefault();
				handleSubmit();
				return;
	...
	if (view.name === "config")
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConfigPanel, {
			config,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MotionOverlay, {
				active: isRunning,
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(
										InputGroupTextarea,
										{
											...
											ref: textareaRef,
											placeholder:
												"Descreva a tarefa, ou aperte o microfone e fale…",
											value: inputValue,
